...
exports.useReducer = exports.setData = exports.removeLink = exports.removeChild = exports.remove = exports.init = exports.getRoot = exports.getMe = exports.getLinkIDs = exports.getLinkID = exports.getChildIDs = exports.getChildID = exports.genUUID = exports.createReducer = exports.addLink = exports.addChild = void 0;
...
const useReducer = theDo => {
  // @ts-ignore
  const [state, dispatch] = (0, _reactHookThunkReducer.default)(theDo.default, {});
...
const init = params => {
  return (dispatch, _) => {
    ...
    if (parentID) {
      doParent == null ? void 0 : doParent.addChild(parentID, {
        id: myID,
        theClass: myClass,
        do: doMe
      });
...
const removeRelation = (dispatch, getState, myID, relationID, relationClass, isFromRelation, relationRemove, removeRelationCore, relationName) => {
  let state = getState();
  let me = state.nodes[myID];
