...
export declare const getStateOrNull: <S extends State>(classState: ClassState<S>, myID?: string) => S | null;
export declare const getState: <S extends State>(classState: ClassState<S>, myID?: string) => S;
