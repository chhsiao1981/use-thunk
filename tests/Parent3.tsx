...
export default (props: Props) => {
  ...
  const [parent3, doParent3] = useThunk<ModParent3.State, typeof ModParent3>(
    ModParent3,
    myID,
  );
  const [defaultParent, _, defaultID] = useThunk<
    ModParent3.State,
    typeof ModParent3
  >(ModParent3);
  ...
  return (
    <>
      ...
      <div className="parent-get-state-by-thunk">
        {myID}:{" "}
        {`${defaultParent === defaultParent3} ${defaultID === defaultID3} true`}
      </div>
