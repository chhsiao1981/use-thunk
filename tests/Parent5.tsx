...
export default (props: Props) => {
  ...
  const [parent, doParent] = useThunk<ModParent5.State, typeof ModParent5>(
    ModParent5,
    myID,
  );
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="parent-reset-child0"
        onClick={onResetChildID0}
      ></button>
      ...
      <button
        type="button"
        className="parent-reset-child1"
        onClick={onResetChildID1}
      ></button>
