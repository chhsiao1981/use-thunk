...
import { resetThunkModuleMap, sleep } from "./utils";
...
it("many-apps6 (init and remove)", async () => {
  ...
  const App = () => {
    ...
    const [_7, doParent3] = useThunk<ModParent3.State, typeof ModParent3>(
      ModParent3,
      parentID0,
    );
    const [_8, doChild3] = useThunk<ModChild3.State, typeof ModChild3>(
      ModChild3,
    );
