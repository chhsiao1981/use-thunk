...
it("many-apps-7 (useThunk)", async () => {
  ...
  const App = () => {
    ...
    const [_7, doParent, parentID0] = useThunk<
      ModParent.State,
      typeof ModParent
    >(ModParent);
    const [_8, doChild4] = useThunk<ModChild4.State, typeof ModChild4>(
      ModChild4,
      childID0,
    );
