...
it("many-apps (init and remove)", async () => {
  ...
  act(() =>
    parentResetChild0s[0].dispatchEvent(
  ...
  act(() =>
    parentResetChild1s[0].dispatchEvent(
      new MouseEvent("click", { bubbles: true }),
    ),
  );
  ...
  act(() =>
    parentButtons[1].dispatchEvent(new MouseEvent("click", { bubbles: true })),
  );
  expect(consoleSpy).not.toHaveBeenCalled();
  ...
  act(() =>
    childButtons02[2].dispatchEvent(new MouseEvent("click", { bubbles: true })),
  );
  ...
  act(() =>
    parentResetChild0s[1].dispatchEvent(
      new MouseEvent("click", { bubbles: true }),
    ),
  );
