...
it("many-apps9 (init and remove)", async () => {
  ...
  const App = () => {
    ...
    useEffect(() => {
      ...
      doChild.init();
      doChild.initWithState(childID0, { count: 0 });
      doChild.initWithState(childID0, { count: 1 });
      doChild.update("non-exist", {});
      doChild.update(childID0, { count: 1 });
    }, []);
  ...
  const parentDefaultNodeIDs = container.querySelectorAll(
    ".parent-default-node-id",
  );
  const parentDefaultCounts = container.querySelectorAll(
    ".parent-default-count",
  );
  const parentRemoves = container.querySelectorAll(".parent-remove");
  const parentGetStates = container.querySelectorAll(
    ".parent-get-state-or-default",
  );
  const parentGetStateByThunks = container.querySelectorAll(
    ".parent-get-state-by-thunk",
  );
  const parentGetStateByThunk2s = container.querySelectorAll(
    ".parent-get-state-by-thunk-2",
  );
  ...
  const child0 = getStateOrNullByModule(modChild, childID0);

  console.info(
    "many-apps9-init-state: after render: childID0:",
    childID0,
    "child0:",
    child0?.count,
  );
  ...
  expect(parentGetStateByThunks[0].textContent).toBe(
    `${parentID0}: true true true`,
  );
  expect(parentGetStateByThunks[1].textContent).toBe(
    `${parentID1}: true true true`,
  );
  expect(parentGetStateByThunks[2].textContent).toBe(
    `${parentID2}: true true true`,
  );
  expect(parentGetStateByThunks[3].textContent).toBe(
    `${parentID3}: true true true`,
  );

  expect(parentGetStateByThunk2s[0].textContent).toBe(
    `${parentID0}: true true true true true true`,
  );
  expect(parentGetStateByThunk2s[1].textContent).toBe(
    `${parentID1}: true true true true true true`,
  );
  expect(parentGetStateByThunk2s[2].textContent).toBe(
    `${parentID2}: true true true true true true`,
  );
  expect(parentGetStateByThunk2s[3].textContent).toBe(
    `${parentID3}: true true true true true true`,
  );

  expect(parentDefaultIDs[0].textContent).toBe(
    `${parentID0}: ${parentDefaultID}`,
  );
  expect(parentDefaultIDs[1].textContent).toBe(
    `${parentID1}: ${parentDefaultID}`,
  );
  expect(parentDefaultIDs[2].textContent).toBe(
    `${parentID2}: ${parentDefaultID}`,
  );
  expect(parentDefaultIDs[3].textContent).toBe(
    `${parentID3}: ${parentDefaultID}`,
  );
  expect(parentDefaultNodeIDs[0].textContent).toBe(
    `${parentID0}: ${parentDefaultID}`,
  );
  expect(parentDefaultNodeIDs[1].textContent).toBe(
    `${parentID1}: ${parentDefaultID}`,
  );
  expect(parentDefaultNodeIDs[2].textContent).toBe(
    `${parentID2}: ${parentDefaultID}`,
  );
  expect(parentDefaultNodeIDs[3].textContent).toBe(
    `${parentID3}: ${parentDefaultID}`,
  );
  ...
  console.info("many-apps9: to click parent-0 button (1st)");
  ...
  act(() =>
    childButtons[3].dispatchEvent(new MouseEvent("click", { bubbles: true })),
  );
  ...
  act(() =>
    childButtons2[4].dispatchEvent(new MouseEvent("click", { bubbles: true })),
  );
  ...
  act(() =>
    childButtons3[5].dispatchEvent(new MouseEvent("click", { bubbles: true })),
  );
  ...
  act(() =>
    parentRemoves[0].dispatchEvent(new MouseEvent("click", { bubbles: true })),
  );

  const parentDefaultIDs2 = container.querySelectorAll(".parent-default-id");
  const parentDefaultNodeIDs2 = container.querySelectorAll(
    ".parent-default-node-id",
  );

  const parentDefaultID2 = parentDefaultIDs2[0].textContent.split(": ")[1];
  expect(parentDefaultID2).toBe(parentDefaultID);
  ...
  expect(parentDefaultIDs2[0].textContent).toBe(
    `${parentID0}: ${parentDefaultID2}`,
  );
  expect(parentDefaultIDs2[1].textContent).toBe(
    `${parentID1}: ${parentDefaultID2}`,
  );
  expect(parentDefaultIDs2[2].textContent).toBe(
    `${parentID2}: ${parentDefaultID2}`,
  );
  expect(parentDefaultIDs2[3].textContent).toBe(
    `${parentID3}: ${parentDefaultID2}`,
  );
  expect(parentDefaultNodeIDs2[0].textContent).toBe(
    `${parentID0}: ${parentDefaultID2}`,
  );
  expect(parentDefaultNodeIDs2[1].textContent).toBe(
    `${parentID1}: ${parentDefaultID2}`,
  );
  expect(parentDefaultNodeIDs2[2].textContent).toBe(
    `${parentID2}: ${parentDefaultID2}`,
  );
  expect(parentDefaultNodeIDs2[3].textContent).toBe(
    `${parentID3}: ${parentDefaultID2}`,
  );
  ...
  const parentMyIDs3 = container.querySelectorAll(".parent-my-id");
  const parentDefaultIDs3 = container.querySelectorAll(".parent-default-id");
  const parentDefaultNodeIDs3 = container.querySelectorAll(
    ".parent-default-node-id",
  );
  const parentDefaultID3 = parentDefaultIDs3[0].textContent.split(": ")[1];

  const parentID03 = parentMyIDs3[0].textContent;
  const parentID13 = parentMyIDs3[1].textContent;
  const parentID23 = parentMyIDs3[2].textContent;
  const parentID33 = parentMyIDs3[3].textContent;

  expect(parentDefaultID3).toBe(parentDefaultID);
  expect(parentDefaultID3).toBe(parentDefaultID2);

  expect(parentID03).toBe(parentID0);
  expect(parentID13).toBe(parentID1);
  expect(parentID23).toBe(parentID2);
  expect(parentID33).toBe(parentID3);
  ...
  expect(parentDefaultIDs3[0].textContent).toBe(
    `${parentID0}: ${parentDefaultID3}`,
  );
  expect(parentDefaultIDs3[1].textContent).toBe(
    `${parentID1}: ${parentDefaultID3}`,
  );
  expect(parentDefaultIDs3[2].textContent).toBe(
    `${parentID2}: ${parentDefaultID3}`,
  );
  expect(parentDefaultIDs3[3].textContent).toBe(
    `${parentID3}: ${parentDefaultID3}`,
  );
  expect(parentDefaultNodeIDs3[0].textContent).toBe(
    `${parentID0}: ${parentDefaultID3}`,
  );
  expect(parentDefaultNodeIDs3[1].textContent).toBe(
    `${parentID1}: ${parentDefaultID3}`,
  );
  expect(parentDefaultNodeIDs3[2].textContent).toBe(
    `${parentID2}: ${parentDefaultID3}`,
  );
  expect(parentDefaultNodeIDs3[3].textContent).toBe(
    `${parentID3}: ${parentDefaultID3}`,
  );
