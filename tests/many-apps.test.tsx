...
it('many-parents (init and remove)', () => {
  ...
  expect(parentDefaultIDs[0].textContent).toBe(`${parentID0}: `)
  expect(parentDefaultIDs[1].textContent).toBe(`${parentID1}: `)
  expect(parentDefaultIDs[2].textContent).toBe(`${parentID2}: `)
  expect(parentDefaultIDs[3].textContent).toBe(`${parentID3}: `)
  expect(parentDefaultNodeIDs[0].textContent).toBe(`${parentID0}: `)
  expect(parentDefaultNodeIDs[1].textContent).toBe(`${parentID1}: `)
  expect(parentDefaultNodeIDs[2].textContent).toBe(`${parentID2}: `)
  expect(parentDefaultNodeIDs[3].textContent).toBe(`${parentID3}: `)
